  ...
  return (
    <AppLayout user={currentUser} onLogout={handleLogout}>
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className='mt-2 text-gray-600 dark:text-gray-400'>{translations.accountSettings}</p>
      </motion.div>
      ...
      <div className='mt-8 grid grid-cols-1 gap-8 lg:grid-cols-3'>
        ...
        <div className='space-y-8 lg:col-span-2'>
          ...
          <motion.div
            ...
            className='rounded-lg border border-gray-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800'
          >
            <h2 className='mb-6 text-2xl font-bold text-gray-900 dark:text-white'>{translations.privacy}</h2>
            <div className='space-y-4'>
              <label className='flex cursor-pointer items-center gap-3'>
                <input type='checkbox' defaultChecked className='h-4 w-4 rounded' />
                <span className='text-sm text-gray-700 dark:text-gray-300'>Allow classmates to see my profile</span>
              </label>
              <label className='flex cursor-pointer items-center gap-3'>
                <input type='checkbox' defaultChecked className='h-4 w-4 rounded' />
                <span className='text-sm text-gray-700 dark:text-gray-300'>Show my grades to teachers</span>
              </label>
              <label className='flex cursor-pointer items-center gap-3'>
                <input type='checkbox' className='h-4 w-4 rounded' />
                <span className='text-sm text-gray-700 dark:text-gray-300'>Share my learning progress</span>
              </label>
            </div>
          </motion.div>
        </div>
        ...
        <div className='space-y-6'>
          ...
          >
            ...
            <div className='space-y-3'>
              <label className='flex cursor-pointer items-center gap-3'>
                <input type='checkbox' defaultChecked className='h-4 w-4 rounded' />
                <span className='text-sm text-gray-700 dark:text-gray-300'>Grade Notifications</span>
              </label>
              <label className='flex cursor-pointer items-center gap-3'>
                <input type='checkbox' defaultChecked className='h-4 w-4 rounded' />
