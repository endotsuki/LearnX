...
export const mockUsers: Record<string, User> = {
  ...
  student1: {
    ...
    role: "student",
    avatar: "https://images.unsplash.com/photo-1517070213482-c482a56d4fe0?w=400&h=400&fit=crop",
    department: "Grade 10",
  ...
  student3: {
    ...
    role: "student",
    avatar: "https://images.unsplash.com/photo-1507631521371-f3f2691fbf92?w=400&h=400&fit=crop",
    department: "Grade 11",
...
export const mockClasses: Class[] = [
  {
    ...
    room: "Room 301",
    image: "https://images.unsplash.com/photo-1516321318423-f06f70a504f2?w=600&h=400&fit=crop",
  },
  {
    id: "class2",
...
export const mockAnnouncements: Announcement[] = [
  {
    ...
    content:
      "The learning management system will be down for maintenance on January 20-21, 2025, from 10 PM to 6 AM.",
  ...
  },
  {
    ...
    content:
      "We've added a new discussion forum for each class to improve student engagement and collaboration.",
    author: mockUsers.admin1,
    createdDate: new Date("2025-01-08"),
    priority: "medium",
  },
  {
    ...
    content:
      "Please ensure your profile information is up to date. This helps us send you relevant notifications.",
    author: mockUsers.admin1,
...
export const getStudentsInClass = (classId: string): User[] => {
  ...
  return enrollments
    .map((e) => getUserById(e.studentId))
    .filter((user): user is User => user !== undefined && user.role === 'student');
};
